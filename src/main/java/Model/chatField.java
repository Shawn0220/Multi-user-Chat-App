...
public class chatField {
    ...
    public chatField(JPanel panel, String id) {
        mPanel = panel;
        gid = id;
    }
    ...
    public static chatField loadaGroupHistory(chatField chatField){
        String gid = chatField.getGid();
        JPanel mJpanel = chatField.getPanel();
        try {
